# BoneSkeleton 骷髅近战化（Minecraft 26.2 Fabric）
...
成品在 `build\libs\boneskeleton-1.2.0+26.2.jar`。

## 怎么装进游戏

把 `build\libs\boneskeleton-1.2.0+26.2.jar` 复制到你的
**Minecraft 26.2 + Fabric** 实例的 `mods` 文件夹里，启动游戏即可。
